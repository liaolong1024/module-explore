package spring.ai.websocket.endpoint;
...
public class UserEndpoint {
    ...
    public void onOpen(@PathParam("sid") String sid, Session session) {
         ...
         */
        LOGGER.info("连接建立中 ==> session_id = {}， sid = {}", session.getId(), sid);
        ...
        sendToOne(sid, "上线了");
        LOGGER.info("连接建立成功，当前在线数为：{} ==> 开始监听新连接：session_id = {}， sid = {},。", onlineSessionClientCount, session.getId(), sid);
    }
    ...
    public void onClose(@PathParam("sid") String sid, Session session) {
        ...
        LOGGER.info("连接关闭成功，当前在线数为：{} ==> 关闭该连接信息：session_id = {}， sid = {},。", onlineSessionClientCount, session.getId(), sid);
    }
    ...
    public void onMessage(String message, Session session) {
        ...
        LOGGER.info("服务端收到客户端消息 ==> fromSid = {}, toSid = {}, message = {}", sid, toSid, message);
    ...
    private void sendToAll(String message) {
        ...
        onlineSessionClientMap.forEach((onlineSid, toSession) -> {
            ...
            if (!sid.equalsIgnoreCase(onlineSid)) {
                LOGGER.info("服务端给客户端群发消息 ==> sid = {}, toSid = {}, message = {}", sid, onlineSid, message);
    ...
    private void sendToOne(String toSid, String message) {
        ...
        // 异步发送
        LOGGER.info("服务端给客户端发送消息 ==> toSid = {}, message = {}", toSid, message);
        toSession.getAsyncRemote().sendText(message);
        /*
        // 同步发送
        try {
